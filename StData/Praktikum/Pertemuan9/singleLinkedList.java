...
// -- -- -- -- --bagian mencangkokkan simpul baru ke dalam simpul lama----------
    ...
    public static void tambahTengah() {
	        ...
	        if (LOKASI == 1) {
	            ...
	            System.out.print("Silakan masukkan IPK anda : ");
	            IPK = masukan.nextFloat();
	            // -- -- -- -- -- --bagian menemukan posisi ya ng dikehendaki--------------
	            simpul bantu;
	            bantu = awal;
	            int N = 1;
	            ...
	            //String yaya = masukan.nextLine();String yaya1 = masukan.nextLine();
	        }
    }
    ...
    public static void hapus(){
	        ...
	        {
	            Scanner masukan = new Scanner(System.in);
	            System.out.print( "Silakan masukkan nama yang ingin diha pus: ");
